...
const BlurText = ({
    ...
    return (
        <p
            ref={ref}
            className={`blur-text ${className} flex  text-center sm:text-left`}
        >
            {elements.map((segment, index) => {
                ...
                return (
                    <motion.span
                        ...
                        animate={inView ? animateKeyframes as unknown as TargetAndTransition : fromSnapshot as unknown as TargetAndTransition}
